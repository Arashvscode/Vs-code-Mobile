...
public class TextActionPopupWindow extends TextComposeBasePopup implements View.OnClickListener, EditorTextActionPresenter {
    ...
    public TextActionPopupWindow(CodeEditor editor) {
        ...
        setContentView(root);
		mContainer.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)25, 0xFF00003A));
		mPasteBtn.setTextColor(0xFF2196F3);
		mSelectAll.setTextColor(0xFF2196F3);
		mCutBtn.setTextColor(0xFF2196F3);
		//tcpw_material_button_paste.setTextColor(0xFF2196F3);
    }
