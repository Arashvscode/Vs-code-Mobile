...
public class PdfReader extends LinearLayout {
    ...
    public void initialize(Context ctx){
        ...
        imageView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 1));
        ...
        pagenumber.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        boutonNext.setTextColor(Color.RED);
        boutonNext.setText("Next");
        ...
        boutonPrevious.setTextColor(Color.RED);
        boutonPrevious.setText("Prev");

        int color = 0xFFd9fffd;
        ...
        boutonNext.setOnClickListener(new OnClickListener() {
            @Override
        ...
        boutonPrevious.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    class CustomImageView extends AppCompatImageView {
        ...
        public void setParameters(Context context, Window window, LinearLayout lin, OpenPdf openPdf, int pageNumber, SeekBar seekBar) {
            this.context = context;
