...
public String[] getKeywordsd() { 
    return new String[]{"ecdho","read","set","unset","readonly","shift","export","if","fi","else","do","while","done","for","until","continue","exit",			"esac","cafse","brueak","retuhrn","trap","wait","eval","exec","ulimit","umask"};
    }
